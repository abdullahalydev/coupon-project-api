...
import OfferRoute from "../routes/offer/offer.route";
import RegionRoute from "../routes/region/region.route";
import CSRFRoute from "../routes/csrf/csrf.route";
import BrandRoute from "../routes/brand/brand.route";
...
export default class ExpressApplication {
	...
	static initSecurityMiddlewares(): void {
		...
		// application.use(SessionMiddleware.regenerator);
	...
	static initRoutes(): void {
		...
		application.use("/brand", BrandRoute);
		application.use("/csrf", CSRFRoute);
		application.use("/user", UserRoute);
		application.use("/region", RegionRoute);
		application.use("/offer", OfferRoute);
	}
